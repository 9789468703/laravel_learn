                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- <a href="#deleteEmployeeModal" class="delete" data-toggle="modal" data-id="<?php echo $user->id; ?>">
                            	<i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a> -->
                            	<a href="javascript:void(0)" class="delete"  data-id="<?php echo $user->id; ?>">
                            	<i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
			...
			<div class="modal-content">
				<?php echo Form::open(array('url' => 'update')); ?>
					...
					<div class="modal-body">
							...
							<input type="text" name="editid" class="form-control editid " hidden required style="display: none;">
									
						<div class="form-group">
							<label>Name</label>
							<input type="text" name="editname" class="form-control editname " required>
						</div>
						<div class="form-group">
							<label>Email</label>
							<input type="email" name="editemail" class="form-control editemail " required >
						</div>
						<div class="form-group">
							<label>Address</label>
							<textarea name="address" class="form-control editaddress " required></textarea>
						</div>
						<div class="form-group">
							<label>Phone</label>
							<input type="text" name="editphone" class="form-control editphone " required>
						</div>					
					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
